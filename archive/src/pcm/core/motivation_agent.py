...
class MotivationAgent:
    ...
    def generate(
        ...
        try:
            ...
            # Strip trailing Chinese bleed-through (qwen2.5 occasionally leaks CJK)
            import re as _re
            text = _re.sub(r"[\u4E00-\u9FFF\uF900-\uFAFF]+.*$", "", text, flags=_re.DOTALL).rstrip()
            # Reject entirely if Chinese dominates
